...
function Library:CreateWindow(title, color)
    ...
    title_18.Font = Enum.Font.FredokaOne
    title_18.Text = title
        ...
        function TabTypes:CreateGroupbox(name, side)
            ...
            function GroupTypes:CreateToggle(name, callback)
                ...
                function ToggleTypes:CreateKeyBind(def, callback)
                    ...
                    bindtext.Font = Enum.Font.FredokaOne
                    bindtext.Text = "[ " .. def .. " ]"
                    ...
                    keymain.Font = Enum.Font.FredokaOne
            ...
            function GroupTypes:CreateSlider(name, min, max, def, callback)
                ...
                title_15.ZIndex = 0
                title_15.Font = Enum.Font.FredokaOne
                title_15.Text = name
            ...
            function GroupTypes:CreateButton(name, callback)
                ...
                title_16.Font = Enum.Font.FredokaOne
                title_16.Text = name
            ...
            function GroupTypes:CreateColorPicker(name, def, callback)
                ...
                title_17.Font = Enum.Font.FredokaOne
                title_17.Text = name
        ...
        function TabTypes:CratePlayerList(showbuttons, events)
            ...
            local function CreatePlayerCard(Name, UserId, MemberShipType, TeamColor)
                ...
                if (showbuttons) then
                    ...
                    whitelist.Font = Enum.Font.FredokaOne
                    whitelist.Text = ""
                    ...
                    blacklist.Font = Enum.Font.FredokaOne
                    blacklist.Text = ""
                    ...
                    prioritize.Font = Enum.Font.FredokaOne
                    prioritize.Text = ""
                    ...
                    unprioritize.Font = Enum.Font.FredokaOne
                    unprioritize.Text = ""
