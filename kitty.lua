...
local defaults; do
                ...
                event:connect(function()
                    local input = frame.InputBegan:connect(function(key)
                        if key.UserInputType == Enum.UserInputType.MouseButton1 or key.UserInputType == Enum.UserInputType.Touch then
                            ...
                            while heartbeat:wait() and inputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or inputService:IsMouseButtonPressed(Enum.UserInputType.Touch) do
                                pcall(function()
    ...
    local types = {}; do
        ...
        function types.window(name, options)
            ...
            newWindow:FindFirstChild("window_toggle").Activated:connect(function()
        ...
        function types:Toggle(name, options, callback)
            ...
            check:FindFirstChild(name).Checkmark.Activated:connect(click)
        ...
        function types:Button(name, callback)
            ...
            check:FindFirstChild(name).Activated:connect(callback)
            self:Resize();
        ...
        function types:Slider(name, options, callback)
            ...
            check:FindFirstChild(name).Container.MouseEnter:connect(function()
                ...
                mouseUpConnection   = game:GetService("UserInputService").InputEnded:connect(function(a, b)
                    if a.UserInputType == Enum.UserInputType.MouseButton1 or a.UserInputType == Enum.UserInputType.Touch and (mouseDownConnection.Connected) then
                        disconnect()
                    end
                end)
            end)    
        ...
        function types:Dropdown(name, options, callback)
            ...
            button.Activated:connect(function()
                ...
                input = game:GetService('UserInputService').InputBegan:connect(function(a)
                    if a.UserInputType == Enum.UserInputType.MouseButton1 or a.UserInputType == Enum.UserInputType.Touch and (not isInGui(container)) then
                        check:FindFirstChild('dropdown_lbl'):WaitForChild('Selection').TextColor3 = library.options.textcolor
